...
import '../../../home/menu/withdraw_cripto_screen.dart';
                ...
                children: [
                  ...
                  TextWithTap(
                    "get_money.left_to_get".tr(namedArgs: {
                      "diamondsNeededToRedeem": (SharedManager()
                                      .getDiamondsNeededToRedeem(
                                          widget.preferences) -
                                  widget.currentUser!.getDiamonds!) >
                              0
                          ? (SharedManager().getDiamondsNeededToRedeem(
                                      widget.preferences) -
                                  widget.currentUser!.getDiamonds!)
                              .toString()
                          : "0"
              ...
              ContainerCorner(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    TextWithTap((SharedManager().getDiamondsNeededToRedeem(
                                    widget.preferences) -
                                widget.currentUser!.getDiamonds!) >
                            0
                        ? (SharedManager().getDiamondsNeededToRedeem(
