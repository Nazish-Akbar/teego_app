...
class MessageListModel extends ParseObject implements ParseCloneable {
  ...
  @override
  MessageListModel clone(Map<String, dynamic> map) =>
      MessageListModel.clone()..fromJson(map);
  ...
  set setMessage(MessageModel messageModel) =>
      set<MessageModel>(keyMessage, messageModel);
