  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: leftButtonWidget != null
              ? leftButtonWidget!
              : Icon(leftButtonIcon,
                  color: iconColor != null ? iconColor : titleColor),
        ...
        actions: [
          rightButtonWidget != null
              ...
              : rightButtonAsset != null || rightButtonIcon != null
                  ? IconButton(
          ...
          rightButtonTwoWidget != null
              ...
              : rightButtonTwoAsset != null || rightButtonTwoIcon != null
                  ? IconButton(
                      icon: rightButtonTwoAsset != null
                          ? QuickActions.showSVGAsset(
                              "assets/svg/$rightButtonTwoAsset",
                              width: iconWidth,
                              height: iconHeight,
                              color: rightIconColor != null
                                  ? rightIconColor
