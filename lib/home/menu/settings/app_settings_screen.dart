...
class _AppSettingsScreenState extends State<AppSettingsScreen> {
  ...
  _getUser() async {
    ...
    setState(() {
      ...
      isDoNotEviteMeToLivePartyEnabled =
          currentUser!.getDenyBeInvitedToLiveParty!;
      isDoNotUsePictureInPictureEnabled =
          currentUser!.getDenyPictureInPictureMode!;
      isAllowViewersToEnterPremiumEnabled =
          currentUser!.getAllowViewersToPremiumStream!;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ToolBar(
      ...
      child: Column(
        children: [
          settingsWidget("application_settings.send_read_receipts".tr(),
              isSendReadReceiptsEnabled, sendReadReceipts),
          settingsWidget("application_settings.enable_one_click".tr(),
              isOnClickGiftingEnabled, onClickGifting),
          settingsWidget("application_settings.do_not_invite_me".tr(),
              isDoNotEviteMeToLivePartyEnabled, liveParty),
          settingsWidget("application_settings.do_not_use_pictures".tr(),
              isDoNotUsePictureInPictureEnabled, pictureInPicture),
          settingsWidget("application_settings.allow_viewers".tr(),
              isAllowViewersToEnterPremiumEnabled, allowViewers),
        ],
      ),
    );
  }
  ...
  _saveDenyInvitationToLivePartyState() async {
    currentUser!.setDenyBeInvitedToLiveParty =
        !isDoNotEviteMeToLivePartyEnabled;
  ...
  _saveDenyPictureInPictureModeState() async {
    currentUser!.setDenyPictureInPictureMode =
        !isDoNotUsePictureInPictureEnabled;
  ...
  _saveAllowUserToEnterPremiumStream() async {
    currentUser!.setAllowViewersToPremiumStream =
        !isAllowViewersToEnterPremiumEnabled;
