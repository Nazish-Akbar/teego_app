...
class CallsModel extends ParseObject implements ParseCloneable {
  ...
  @override
  CallsModel clone(Map<String, dynamic> map) =>
      CallsModel.clone()..fromJson(map);
  ...
  set setReceiverId(String receiverId) =>
      set<String>(keyReceiverId, receiverId);
  ...
  set setCallEndReason(String callEndReason) =>
      set<String>(keyCallEndReason, callEndReason);
}
