    ...
    switch (settings.name) {
      ...
      case QuickHelp.pageTypeTerms:
        return MaterialPageRoute(
            builder: (_) => WebViewScreen(pageType: QuickHelp.pageTypeTerms));
      case QuickHelp.pageTypePrivacy:
        return MaterialPageRoute(
            builder: (_) => WebViewScreen(pageType: QuickHelp.pageTypePrivacy));
      case QuickHelp.pageTypeWhatsapp:
        return MaterialPageRoute(
            builder: (_) =>
                WebViewScreen(pageType: QuickHelp.pageTypeWhatsapp));
      ...
      case QuickHelp.pageTypeSupport:
        return MaterialPageRoute(
            builder: (_) => WebViewScreen(pageType: QuickHelp.pageTypeSupport));
      case QuickHelp.pageTypeCashOut:
        return MaterialPageRoute(
            builder: (_) => WebViewScreen(pageType: QuickHelp.pageTypeCashOut));
