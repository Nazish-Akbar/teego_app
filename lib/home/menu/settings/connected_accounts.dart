...
class ConnectedAccountsScreen extends StatefulWidget {
  ...
  @override
  _ConnectedAccountsScreenState createState() =>
  ...
  _onPressEvent(String type, bool isConnected) {
    switch (type) {
      case "Facebook":
        ...
        isFacebookAccountConnected = !isConnected
      ...
      case "Instagram":
        ...
        isInstagramAccountConnected = !isConnected
            ? !isInstagramAccountConnected
            : isInstagramAccountConnected;
        break;
      ...
      default:
        ...
        isGoogleAccountConnected =
            !isConnected ? !isGoogleAccountConnected : isGoogleAccountConnected;
    }
  }
