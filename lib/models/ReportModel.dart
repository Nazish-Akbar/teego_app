...
class ReportModel extends ParseObject implements ParseCloneable {
  ...
  @override
  ReportModel clone(Map<String, dynamic> map) =>
      ReportModel.clone()..fromJson(map);
  ...
  set setReportType(String reportType) =>
      set<String>(keyReportType, reportType);
  ...
  set setPost(PostsModel postsModel) =>
      set<PostsModel>(keyReportPost, postsModel);

  LiveStreamingModel? get getLiveStreaming =>
      get<LiveStreamingModel>(keyReportLiveStreaming);
  set setLiveStreaming(LiveStreamingModel liveStreamingModel) =>
      set<LiveStreamingModel>(keyReportLiveStreaming, liveStreamingModel);
}
