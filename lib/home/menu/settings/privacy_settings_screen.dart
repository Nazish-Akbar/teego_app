...
class _PrivacySettingsScreenState extends State<PrivacySettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ToolBar(
      ...
      child: Column(
        children: [
          settingsWidget("privacy_settings.title_see_my_posts".tr(), null,
              typeCanSee, QuickHelp.getShowMyPostToMessage(showMyPostToCode)),
          settingsWidget("privacy_settings.title_receive_chat_request".tr(),
              isReceiveChatRequest, typeReceive, ""),
          settingsWidget("privacy_settings.title_show_in_search".tr(),
              isShowUpInSearch, typeSearch, ""),
          settingsWidget("privacy_settings.title_show_vip_lever".tr(),
              isShowVipLevel, typeVip, ""),
          settingsWidget("privacy_settings.title_show_location".tr(),
              isShowLocation, typeLocation, ""),
          settingsWidget("privacy_settings.title_show_last_time_seen".tr(),
              isShowLastTimeSeen, typeLastTime, ""),
          settingsWidget(
              "privacy_settings.title_invisible_mode".tr(),
              isInvisibleMode,
              typeInvisible,
              "privacy_settings.explain_invisible_mode".tr()),
        ],
      ),
    );
  }
  ...
  ContainerCorner settingsWidget(
      String text, bool? isEnabled, String type, String description) {
    ...
    showDialog(
        ...
        builder: (context) => AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ListTile(
                      title: Text("privacy_settings.explain_see_my_posts"
