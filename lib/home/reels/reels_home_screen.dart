...
import '../../home/feed/videoutils/api.dart';
import '../../home/feed/videoutils/screen_config.dart';
import '../../home/feed/videoutils/video.dart';
import '../../home/feed/videoutils/video_item_config.dart';
import '../../home/feed/videoutils/video_newfeed_screen.dart';
import '../../home/reels/reels_video_screen.dart';
    ...
    return ToolBarReels(
      ...
      /*appBar: AppBar(
        ...
        title: TabBar(
          ...
          isScrollable: true,
          tabs: [
            Tab(text: "feed.for_all".tr()),
            Tab(text: "feed.exclusive_".tr()),
          ],
