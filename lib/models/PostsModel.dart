...
class PostsModel extends ParseObject implements ParseCloneable {
  ...
  set setVideo(ParseFileBase imageFile) =>
      set<ParseFileBase>(keyVideo, imageFile);

  ParseFileBase? get getVideoThumbnail => get<ParseFileBase>(keyVideoThumbnail);
  set setVideoThumbnail(ParseFileBase imageFile) =>
      set<ParseFileBase>(keyVideoThumbnail, imageFile);
